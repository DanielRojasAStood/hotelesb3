...
$headerFooter     = get_page_by_path('content-header-footer')->ID;
...
<a href="<?php echo $link_payu ?>" target="<?php echo $target_payu; ?>">
    <img src="<?php echo $icon_payu; ?>" alt="<?php echo $alt_payu; ?>" width="60" height="30" title="<?php echo $title_payu; ?>">
</a>
<a href="<?php echo $link_instagram ?>" target="<?php echo $target_instagram; ?>">
    <img src="<?php echo $icon_instagram; ?>" alt="<?php echo $alt_instagram; ?>" width="30" height="30" title="<?php echo $title_instagram; ?>">
</a>
<a href="<?php echo $link_tiktok ?>" target="<?php echo $target_tiktok; ?>">
    <img src="<?php echo $icon_tiktok; ?>" alt="<?php echo $alt_tiktok; ?>" width="30" height="30" title="<?php echo $title_tiktok; ?>">
</a>
<a href="<?php echo $link_facebook ?>" target="<?php echo $target_facebook; ?>">
    <img src="<?php echo $icon_facebook; ?>" alt="<?php echo $alt_facebook; ?>" width="30" height="30" title="<?php echo $title_facebook; ?>">
</a>
<a href="<?php echo $link_youtube ?>" target="<?php echo $target_youtube; ?>">
    <img src="<?php echo $icon_youtube; ?>" alt="<?php echo $alt_youtube; ?>" width="30" height="30" title="<?php echo $title_youtube; ?>">
</a>